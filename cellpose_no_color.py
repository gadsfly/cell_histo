...
# Load grayscale images directly
print("\n1. Loading grayscale images...")
base_path = '/home/lq53/mir_repos/histology_for_minji/no_color_fix/'

dapi = io.imread(base_path + 'ch00.tiff')
th = io.imread(base_path + 'ch01.tiff')
oxy = io.imread(base_path + 'ch02.tiff')
cfos = io.imread(base_path + 'ch03.tiff')
